...
function TeamSection({ title, subtitle, members }: { title: string; subtitle: string; members: typeof coreTeam }) {
  return (
  ...
  return (
    <section id="team" className="relative py-28 bg-grid">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <TeamSection title="核心团队" subtitle="Core Team" members={coreTeam} />
        <TeamSection title="脚本作者" subtitle="Script Authors" members={scriptAuthors} />
      </div>
    </section>
  );
}
